...
It's an important way to provide feedback to the search agent by labeling the relevance scores of each returned papers. Simplify however over your mouse to `Relevance 1` for each paper node, and it will pop up the 1 - 5 scale for you to select.
